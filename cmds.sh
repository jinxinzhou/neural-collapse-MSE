...
#
#
#python train_2nd_order.py --gpu_id 0 --uid mnist_CE_LBFGS_bias_true --dataset mnist --loss CrossEntropy --optimizer LBFGS --lr 0.1 --history_size 10 --batch_size 4096
#
...
python train_2nd_order.py --gpu_id 0 --uid mnist_CE_LBFGS_bias_true_batch_size_2048_weightDecay_default --dataset mnist --loss CrossEntropy --optimizer LBFGS --lr 0.1 --history_size 10 --batch_size 2048
python validate_NC.py /--gpu_id 0 --dataset mnist --batch_size 4096 --load_path model_weights/mnist_CE_LBFGS_bias_true_batch_size_2048_weightDecay_default
python plot.py --path model_weights/mnist_CE_LBFGS_bias_true_batch_size_2048_weightDecay_default